...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['loginBtn'])) {
  pr($_POST);
    ...
    if (empty($emailErr) && empty($passwordErr)) {
        // Only select Admin users from Users table
        $stmt = $conn->prepare("SELECT * FROM users WHERE `users`.`email` = ? AND `users`.`user_type` = 'Admin';");
...
<head>
  ...
  <title>Login - Legal Services</title>
